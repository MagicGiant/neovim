...
Перезагрузить систему. Если не получается:
Установите шрифты с поддержкой китайских символов (например, Noto Sans CJK SC, WenQuanYi Micro Hei или Source Han Sans CN) для всех категорий:
  * General: Noto Sans CJK SC
  * Fixed width: Noto Sans Mono CJK SC
...
[Ролик](https://www.youtube.com/watch?v=6qzyWLZha0E&t=1023s)
...
## Добавление venv Python

```sh
cd ~
python(v.v) -m venv  venv
