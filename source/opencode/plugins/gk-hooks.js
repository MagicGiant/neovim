// gk-managed:{"events":["permission.asked","permission.replied","session.compacted","session.created","session.deleted","session.error","session.idle","session.status","session.updated","tool.execute.after","tool.execute.before"],"executable":"/home/sherka/.local/share/GitKrakenCLI/gk"}
...
const EXECUTABLE = "/home/sherka/.local/share/GitKrakenCLI/gk";
